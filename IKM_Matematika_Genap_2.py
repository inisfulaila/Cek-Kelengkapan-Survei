...
def load_data():
    DATABASE_SHEET_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vTbu89G0AtEKxeAXKQ4ScMFqvQ-k4qg_dJYP0KtKBIir77YLP1ZupK-ROyrWUsgCb3ygPLU5H725eYy/pub?gid=621313620&single=true&output=csv"
    RESPONSE_SHEET_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRm3mrzpHhraRy_mV2-1HROt2bXF2fT_LFs2zS6HxDzjveyrP42VWMJaVNk56iHkWJ9KAJO09DIsx5T/pub?gid=0&single=true&output=csv"
    ...
    response_data['Pemasaran Mata Kuliah'] = response_data['Pemasaran Mata Kuliah'].str.strip().str.upper()
    ...
    if student_id:
        ...
        if not student_courses.empty:
            ...
            student_courses['IKM Sudah Terisi'] = student_courses['Matakuliah'].apply(
                lambda x: 'Sudah' if x in response_data_filtered['Pemasaran Mata Kuliah'].values else 'Belum'
            )
